...
mod tests {
    ...
    mod t_add {
        ...
        fn use_shortcut_lhs_zero() {
            test_shorcut::<add::Zero, Left>(0, NON_ZERO, (), NON_ZERO);
        }
        #[test]
        fn use_shortcut_rhs_zero() {
            test_shorcut::<add::Zero, Right>(NON_ZERO, 0, (), NON_ZERO);
        }
        #[test]
        fn use_shortcut_both_zero() {
            test_shorcut::<add::Zero, Left>(0, 0, (), 0);
            test_shorcut::<add::Zero, Right>(0, 0, (), 0);
        }
    }
    mod t_sub {
        use super::*;
        ...
        #[test]
        fn use_shortcut_lhs_zero() {
            test_shorcut::<sub::Zero, Left>(NON_ZERO, 0, (), -NON_ZERO);
        }
        #[test]
        fn use_shortcut_rhs_zero() {
            test_shorcut::<sub::Zero, Right>(NON_ZERO, 0, (), NON_ZERO);
        }
        #[test]
        fn use_shortcut_both_zero() {
            test_shorcut::<sub::Zero, Left>(0, 0, (), 0);
            test_shorcut::<sub::Zero, Right>(0, 0, (), 0);
        }
    }
    ...
    mod t_mul {
        mod zero {
            ...
            #[test]
            fn use_shortcut_lhs_zero() {
                test_shorcut::<mul::ByZero, Left>(0, NON_ZERO, (), 0);
            }
            #[test]
            fn use_shortcut_rhs_zero() {
                test_shorcut::<mul::ByZero, Right>(NON_ZERO, 0, (), 0);
            }
            #[test]
            fn use_shortcut_both_zero() {
                test_shorcut::<mul::ByZero, Left>(0, 0, (), 0);
                test_shorcut::<mul::ByZero, Right>(0, 0, (), 0);
            }
        }
        mod one {
            use super::super::*;
            ...
            fn use_shortcut_lhs_one() {
                test_shorcut::<mul::ByOne, Left>(1, NON_ONE, (), NON_ONE);
            }
            #[test]
            fn use_shortcut_rhs_one() {
                test_shorcut::<mul::ByOne, Right>(NON_ONE, 1, (), NON_ONE);
            }
            #[test]
            fn use_shortcut_both_one() {
                test_shorcut::<mul::ByOne, Left>(1, 1, (), 1);
                test_shorcut::<mul::ByOne, Right>(1, 1, (), 1);
            }
        }
